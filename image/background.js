...
function createBackground(url, colorObject, callback) {
  ...
  fs.exists(path, function(exists) {
    ...
    utils.download(url, cacheFile, function() {
      ...
      var command = "convert " + cacheFile + " -depth 8 -colorspace gray -colorspace RGB  -resize 480x270\^ -morphology Open Octagon -gravity North -crop 480x270+0+50 -median 6 -fill " + rgb + " -auto-level -auto-gamma -colorize 35% -brightness-contrast -22x27 -sigmoidal-contrast 16x20% -strip " + path;
